    ...
    require(["DS/WAFData/WAFData", "DS/DataDragAndDrop/DataDragAndDrop"], function (WAFData, DataDragAndDrop) {
        var myWidget = {
            ...
            onLoadWidget: function () {
                ...
                $('#idTezgah1Clear').click(function () {
                    myWidget.wafDataPatchFunctionForClearButton(objectID, cestamp, 1);
                });
                $('#idTezgah2Clear').click(function () {
                    myWidget.wafDataPatchFunctionForClearButton(objectID, cestamp, 2);
                });
                $('#idTezgah3Clear').click(function () {
                    myWidget.wafDataPatchFunctionForClearButton(objectID, cestamp, 3);
                });
